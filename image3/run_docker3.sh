...
# CONTAINER_NAME3="my1-app1"
# IMAGE_NAME3="my1-app"
# LOCAL_PORT3="8000"
# CONTAINER_PORT3="8000"

echo -e "${BLUE}Stopping and removing existing container...${NC}"
docker rm -f $CONTAINER_NAME3 2>/dev/null || true
...
docker run -d --name $CONTAINER_NAME3 -p $LOCAL_PORT3:$CONTAINER_PORT3 $IMAGE_NAME3
...
docker tag "${IMAGE_NAME3}:latest"  "${AR_NAME}/${IMAGE_NAME3}:latest"

# Push it to the cloud
docker push    "${AR_NAME}/${IMAGE_NAME3}:latest"
